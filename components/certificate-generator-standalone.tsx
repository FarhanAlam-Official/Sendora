    ...
    try {
      ...
      if (useCustomTemplate && customTemplateFile && customTemplatePreview) {
        ...
        pdfFiles = await generateCertificateBatch(
          ...
          signature,
          customFontSizes,
          template || undefined, // Pass the template with custom fonts
        )
      }
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-muted/50 rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Checkbox
                          id="italic-checkbox-standalone"
                          checked={namePosition.italic}
                          onCheckedChange={(checked) => setNamePosition((prev) => ({ ...prev, italic: checked === true }))}
                        />
                        <Label htmlFor="italic-checkbox-standalone" className="text-xs cursor-pointer">
                          Italic
                        </Label>
                      </div>
                      <div className="flex items-center gap-2">
                        <Checkbox
                          id="underline-checkbox-standalone"
                          checked={namePosition.underline}
                          onCheckedChange={(checked) => setNamePosition((prev) => ({ ...prev, underline: checked === true }))}
                        />
                        <Label htmlFor="underline-checkbox-standalone" className="text-xs cursor-pointer">
                          Underline
                        </Label>
                      </div>
                    </div>
                  ...
                  <div className="mb-4 p-4 border border-border rounded-lg bg-muted/50">
                    ...
                    <div className="border-2 border-dashed border-border rounded-lg p-4 text-center">
                      <input
                        ...
                        className="hidden"
                        id="font-upload-standalone"
                        disabled={uploadingFont}
                      />
                      <label htmlFor="font-upload-standalone" className={`cursor-pointer ${uploadingFont ? "opacity-50" : ""}`}>
